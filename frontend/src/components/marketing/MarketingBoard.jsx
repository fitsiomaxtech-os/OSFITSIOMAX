...
import {
  FileSpreadsheet, Layers, Users, ChevronDown, Target,
...
//
// Every figure here is one the endpoint already computes — nothing is derived in the
// component, so what the tile says is what /team-members counted. "Converted" is leads
// that reached Assigned Physio; it is deliberately not called "Appt Booked", which is a
// different event and one nothing currently counts per agent.
const TEAM_TIERS = {
  pre_sales: {
    icon: Users,
...
const TeamCard = ({ title, subtitle, members, kind }) => {
